...
class QsxySpider(scrapy.Spider):
    name = 'qsxy'
    allowed_domains = ['qsxy.zju.edu.cn']
    start_urls = ['http://qsxy.zju.edu.cn/30845/list1.htm']
    counter = 1

    def __init__(self):
        self.stop_crawling = False
        self.base_url = 'http://qsxy.zju.edu.cn'
    ...
    def setup_db(self):
        ...
        self.cursor.execute('''
            CREATE TABLE IF NOT EXISTS qiushi (
    ...
    def save_to_db(self, data):
        self.cursor.execute('''
            INSERT INTO qiushi (title, date, link, content) VALUES (?, ?, ?, ?)
